...
@pytest.mark.parametrize("filename,expected", [
    ("master_sheet_20230101.csv", "20230101"),
    ("master_sheet_2023-01-01.csv", "2023-01-01"),
    ("data/na/results_consolidation/master_sheets/report_20221231.csv", "20221231"),
    ("data/na/results_consolidation/master_sheets/report_2022-12-31.csv", "2022-12-31"),
    ("data/na/results_consolidation/master_sheets/no_timestamp.csv", None),
    ("data/na/results_consolidation/master_sheets/2023.csv", None),
])
def test_extract_timestamp_from_filename(filename, expected):
    downloader = Mastersheet2Snowflake()
    timestamp = downloader.extract_timestamp_from_filename(filename)
